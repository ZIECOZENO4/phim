...
<SideBar />
  ...
  <div
                                                class="md:hidden h-full flex flex-col  shadow-xl overflow-y-scroll">
                                              
                                                <div class=" shadow-lg pb-3 rounded-b-3xl">
                                                    <div
                                                        class="flex  rounded-b-3xl  space-y-5 flex-col items-center py-7">
                                                ...
                                                <div class="flex mx-auto mt-3 w-100 ">
                                                    <a href=""> <button
                                                            class="p-2 text-xl shadow-lg rounded-2xl tr-300 w-100 font-medium  bg-red-700 rounded-md hover:bg-green-600 text-gray-50">
                                                            Log Out</button></a>
                                                </div>
                                            </div>
</div>

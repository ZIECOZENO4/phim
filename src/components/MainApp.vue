...
<template class="w-[100vw] h-[100vh] overflow-hidden">
  <div class="bg-bg bg-no-repeat bg-cover w-[100vw] overflow-hidden">
    <nav class="sticky z-10">
      <NavBar />
    </nav>

    <div class="w-[100vw] p-0 m-0 bg-black bg-opacity-80 hidden md:flex md:flex-row">
      <SideBar />
    </div>
    <div class=" "></div>
    <div class="md:hidden h-full flex flex-col shadow-xl overflow-y-scroll text-white">
      <div class="shadow-lg pb-3 rounded-b-3xl">
        ...
        >
          ...
          <div class="col-span-1 px-3 flex flex-col items-center">
            <span class="text-2xl font-bold text-white"> 546</span>
      ...
      <div
        class="grid rounded-2xl divide-y divide-dashed hover:divide-solid justify-evenly m-3 mt-10 grid-cols-3"
      >
          ...
          <div class="flex flex-col items-center">
            <a href="">
              <button class="tr-300">
                ...
                <span class="text-lg font-medium">Cast</span>
              </button></a
            >
          </div>
        </div>
          ...
          <div class="flex flex-col items-center">
            <a href="">
              <button class="tr-300">
                ...
                <span class="text-lg font-medium">Alert</span>
              </button></a
            >
          </div>
        </div>
          ...
          <div class="flex flex-col items-center">
            <a href="">
              <button class="tr-300">
                ...
                <span class="text-lg font-medium">Doc</span>
              </button></a
            >
          </div>
        </div>
      ...
      <div class="flex mx-auto mt-3 w-100">
        <a href="">
          <button
            class="p-2 text-xl shadow-lg rounded-2xl tr-300 w-100 font-medium bg-blue-500 rounded-md hover:bg-green-600 text-gray-50"
          >
          Sponsor Me
          </button></a
        >
